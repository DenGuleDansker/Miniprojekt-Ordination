...
public class PNTest
{
    ...
    public void GivDosisTesting()
    {
        ...
        PN TC1 = new PN(new DateTime(2023, 11, 01), new DateTime(2023, 11, 10), 123, new Laegemiddel("Paracematol", 0.5, 1, 1.5, "Styk"));
        ...
        PN TC2 = new PN(new DateTime(2023, 11, 01), new DateTime(2023, 11, 10), 123, new Laegemiddel("Paracematol", 0.5, 1, 1.5, "Styk"));
        ...
        PN TC3 = new PN(new DateTime(2023, 11, 01), new DateTime(2023, 11, 10), 123, new Laegemiddel("Paracematol", 0.5, 1, 1.5, "Styk"));
        ...
        PN TC4 = new PN(new DateTime(2023, 11, 01), new DateTime(2023, 11, 10), 123, new Laegemiddel("Paracematol", 0.5, 1, 1.5, "Styk"));
        ...
        //TC4 - tester om dosis kan gives inden starten af perioden.
        PN TC5 = new PN(new DateTime(2023, 11, 01), new DateTime(2023, 11, 10), 123, new Laegemiddel("Paracematol", 0.5, 1, 1.5, "Styk"));
